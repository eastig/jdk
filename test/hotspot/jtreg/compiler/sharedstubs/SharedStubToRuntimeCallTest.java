...
/**
 * @test SharedStubToRuntimeCallTest
 ...
 *
 * @run driver compiler.sharedstubs.SharedStubToRuntimeCallTest
 */
...
public class SharedStubToRuntimeCallTest {
    ...
    private static void runTest(String compiler, String test) throws Exception {
        String testClassName = SharedStubToRuntimeCallTest.class.getName() + "$" + test;
