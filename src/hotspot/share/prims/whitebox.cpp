...
WB_ENTRY(jlong, WB_GetHeapMaxCapacity(JNIEnv* env, jobject o, jint blob_type))
  CodeHeap* heap = WhiteBox::get_code_heap(static_cast<CodeBlobType>(blob_type));
  return (jlong)heap->max_capacity();
WB_END
...
static JNINativeMethod methods[] = {
  ...
  {CC"getHeapMaxCapacity",               CC"(I)J",                  (void*)&WB_GetHeapMaxCapacity},
